...
class JewelleryRepository {
  ...
  // /// Diamond
  // static List<JewelleryModel> diamond2 = [
  //   JewelleryModel(
  //       name: 'Chain necklace with cubic zirconia initial',
  //       description:
  //           'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
  ...
  static List<JewelleryModel> diamond2 = [
    JewelleryModel(
        name:
            'lfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkglfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkglfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkg',
        description:
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
        price: 29.99,
        image:
    ...
    JewelleryModel(
        name:
            'aahdkl;hga;lhdsak;lhg;klasdhk;glhaklsdhg;kladslfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkglfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkg',
        description:
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
        price: 20.00,
        image:
    ...
    JewelleryModel(
        name:
            'jkfl;hasdlk;fhl;kashfklhdaskljfhkldsahklfhklsadhflksdhaklfhlkslfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkglfkgshl;hdfgkl;hsd;lkhkls;dfhglsdhfkg',
        description:
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
        price: 17.99,
        image:
